...
import { FiCheckCircle, FiGlobe, FiZap, FiSearch, FiMic, FiShoppingCart, FiBarChart2 } from 'react-icons/fi';
import Image from "next/image";
import helmet from "../../../public/images/helmet.png"

const Hero = () => {
  return (
    <section className="relative min-h-screen pt-32 pb-20 overflow-hidden bg-[#f8faff]">

      {/* Subtle background shapes */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-blue-100 rounded-full blur-3xl opacity-40 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-indigo-100 rounded-full blur-3xl opacity-30 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-gray-900 leading-[1.2] mb-6">
          Sell Anywhere, Manage Everything, <br/>
            
            Without the Stress<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-700">.</span>
           
          </h1>

          <p className="max-w-2xl mx-auto text-gray-600 text-lg font-normal mb-10 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
          ...
          <div className="lg:col-span-7 relative overflow-hidden rounded-[32px] border border-gray-200 bg-white p-8">
            ...
            {/* Accent blob */}
            <div className="absolute -top-16 -right-16 w-72 h-72 bg-blue-50 rounded-full blur-3xl opacity-60 pointer-events-none" />
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-gray-200 bg-white p-5">
              <div className="absolute -top-8 -right-8 w-32 h-32 bg-indigo-50 rounded-full blur-2xl" />
              <div className="relative z-10">
                ...
                <div className="mt-5 flex gap-2 flex-wrap">
                  {["SSL", "bKash", "Pathao", "Shohoz"].map((b) => (
                    <span key={b} className="text-[10px] font-semibold text-gray-500 bg-gray-100 border border-gray-200 px-2 py-1 rounded-lg">
                      {b}
                    </span>
                  ))}
                </div>
            ...
            <div className="rounded-[32px] bg-gradient-to-br from-blue-500 to-blue-700 p-5 relative overflow-hidden group shadow-lg shadow-blue-200">
              ...
              <div className="relative z-10 rounded-full border border-white/30 bg-white/15 backdrop-blur-sm px-3 py-2 flex items-center gap-2">
                ...
                <p className="flex-1 text-xs text-white/80 font-light">
                  "red cycle helmet"
                </p>
