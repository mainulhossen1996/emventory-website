  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-screen-xl mx-auto">
        ...
        {/* Simple & Clean Header */}
        <div className="mb-8">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-xs font-bold uppercase tracking-[0.2em] mb-4">
              <FiBox />
              Retail Categories
            </div>
